 ...
 <form action="/profile/{{ $user->id }}" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
            ...
            <div class="col-8 offset-2">
             ...
             <label for="title" class="col-md-4 col-form-label">Enter title</label>
              ...
              <div class="form-group row">
             <label for="description" class="col-md-4 col-form-label">Enter description</label>
              ...
              <div class="form-group row">
             <label for="url" class="col-md-4 col-form-label">Enter URL</label>
            ...
            <div class="row pt-4">
            <button class="btn btn-outline-dark" type="submit">Add New Post</button>
            </div>
